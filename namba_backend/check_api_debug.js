...
const check = async () => {
  try {
    const res = await axios.get('http://localhost:5000/api/v1/admin/drivers');
    ...
    const perfRes = await axios.get('http://localhost:5000/api/v1/admin/performance-analytics');
