...
class _DeliveryDashboardScreenState extends State<DeliveryDashboardScreen>
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text('₹$amount', style: GoogleFonts.outfit(color: AppTheme.primaryOrange, fontSize: 48, fontWeight: FontWeight.w900, letterSpacing: -2)),
                    Text('EARNING', style: GoogleFonts.outfit(color: AppTheme.lightText, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 2)),
                            ...
                            onTap: () async {
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (c) => AlertDialog(
                                  ...
                                  title: Text('Decline Order?', style: GoogleFonts.outfit(fontWeight: FontWeight.w900)),
                                  content: Text('Are you sure you want to decline this assignment? This may affect your performance rating.', 
                                  ...
                                  actions: [
                                    ...
                                    TextButton(
                                      ...
                                      child: Text('DECLINE', style: GoogleFonts.outfit(color: Colors.red, fontWeight: FontWeight.w900)),
                                    ),
                                  ],
                                ),
                              );
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Text('DECLINE', style: GoogleFonts.outfit(
                                    color: Colors.red.shade500, fontSize: 13, fontWeight: FontWeight.w900)),
                                ],
                              ),
                            ),
                          ),
  ...
  Widget _buildPrimeJobCard(CoreOrder order) {
    final provider = Provider.of<DeliveryProvider>(context, listen: false);
        ...
        children: [
          Row(children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Text('₹${order.total.toStringAsFixed(0)}', style: GoogleFonts.outfit(color: AppTheme.accentGreen, fontSize: 24, fontWeight: FontWeight.w900, letterSpacing: -1)),
              Container(
          ...
          Row(children: [
            // Decline
            GestureDetector(
              onTap: () async => provider.declineAssignment(order.id),
              child: Container(
                width: 52, height: 52,
                ...
                child: Icon(icons.Iconsax.close_circle_copy, color: Colors.red.shade400, size: 22),
              ),
            ),
            const SizedBox(width: 12),
            // Accept
