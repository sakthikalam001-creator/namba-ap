...
class LocalSyncService {
  ...
  static Future<void> updateOrderStatus(String orderId, CoreOrderStatus status, {String? rawStatus, double? newTotal, double? newSubtotal, double? newDeliveryFee, double? newPlatformFee, Map<String, dynamic>? driver, int? billUploadedAt}) async {
    await updateOrder(orderId, {
      ...
      if (billUploadedAt != null) 'billUploadedAt': billUploadedAt,
    });
  }
